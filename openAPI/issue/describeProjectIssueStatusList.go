...
func (i *Issue) DescribeProjectIssueStatusList(req *DescribeProjectIssueStatusListReq) (resp DescribeProjectIssueStatusListResp, err error) {
	err = poster.Post(i.c, "DescribeProjectIssueStatusList", req, &resp)
	return
}

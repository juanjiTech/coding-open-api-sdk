...
func (i *Issue) DescribeIssueListWithPage(req *DescribeIssueListWithPageReq) (resp DescribeIssueListWithPageResp, err error) {
	err = poster.Post(i.c, "DescribeIssueListWithPage", req, &resp)
	return
}

...
func (i *Issue) DescribeIssueStatusChangeLogList(req *DescribeIssueStatusChangeLogListReq) (resp DescribeIssueStatusChangeLogListResp, err error) {
	err = poster.Post(i.c, "DescribeIssueStatusChangeLogList", req, &resp)
	return
}

...
func (i *Issue) DescribeIssueFileUrl(req *DescribeIssueFileUrlReq) (resp DescribeIssueFileUrlResp, err error) {
	err = poster.Post(i.c, "DescribeIssueFileUrl", req, &resp)
	return
}

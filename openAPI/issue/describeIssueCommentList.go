...
func (i *Issue) DescribeIssueCommentList(req *DescribeIssueCommentListReq) (resp DescribeIssueCommentListResp, err error) {
	err = poster.Post(i.c, "DescribeIssueCommentList", req, &resp)
	return
}

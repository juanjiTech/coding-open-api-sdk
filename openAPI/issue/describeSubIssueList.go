...
func (i *Issue) DescribeSubIssueList(req *DescribeSubIssueListReq) (resp DescribeSubIssueListResp, err error) {
	err = poster.Post(i.c, "DescribeSubIssueList", req, &resp)
	return
}

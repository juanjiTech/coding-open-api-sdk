...
func (i *Issue) DescribeIssueFilterList(req *DescribeIssueFilterListReq) (resp DescribeIssueFilterListResp, err error) {
	err = poster.Post(i.c, "DescribeIssueFilterList", req, &resp)
	return
}

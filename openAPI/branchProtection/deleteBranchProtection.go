...
func (b *BranchProtection) DeleteBranchProtection(req *DeleteBranchProtectionReq) (resp DeleteBranchProtectionResp, err error) {
	err = poster.Post(b.c, "DeleteBranchProtection", req, &resp)
	return
}

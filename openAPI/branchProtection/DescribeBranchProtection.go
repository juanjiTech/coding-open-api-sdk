...
func (b *BranchProtection) DescribeBranchProtection(req *DescribeBranchProtectionReq) (resp DescribeBranchProtectionResp, err error) {
	err = poster.Post(b.c, "DescribeBranchProtection", req, &resp)
	return
}

...
func (r *Requirement) DescribeRequirementDefectRelation(req *DescribeRequirementDefectRelationReq) (resp DescribeRequirementDefectRelationResp, err error) {
	err = poster.Post(r.c, "DescribeRequirementDefectRelation", req, &resp)
	return
}

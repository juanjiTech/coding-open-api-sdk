...
func (c *Cd) DescribeCdPipelineConfig(req *DescribeCdPipelineConfigReq) (resp DescribeCdPipelineConfigResp, err error) {
	err = poster.Post(c.c, "DescribeCdPipelineConfig", req, &resp)
	return
}

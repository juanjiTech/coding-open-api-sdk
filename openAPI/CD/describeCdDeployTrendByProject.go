...
func (c *Cd) DescribeCdDeployTrendByProject(req *DescribeCdDeployTrendByProjectReq) (resp DescribeCdDeployTrendByProjectResp, err error) {
	err = poster.Post(c.c, "DescribeCdDeployTrendByProject", req, &resp)
	return
}

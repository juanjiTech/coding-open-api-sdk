...
func (c *Cd) DescribeCdPipelineConfigs(req *DescribeCdPipelineConfigsReq) (resp DescribeCdPipelineConfigsResp, err error) {
	err = poster.Post(c.c, "DescribeCdPipelineConfigs", req, &resp)
	return
}

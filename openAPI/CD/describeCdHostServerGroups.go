...
func (c *Cd) DescribeCdHostServerGroups(req *DescribeCdHostServerGroupsReq) (resp DescribeCdHostServerGroupsResp, err error) {
	err = poster.Post(c.c, "DescribeCdHostServerGroups", req, &resp)
	return
}

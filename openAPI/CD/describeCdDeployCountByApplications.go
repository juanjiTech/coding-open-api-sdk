...
func (c *Cd) DescribeCdDeployCountByApplications(req *DescribeCdDeployCountByApplicationsReq) (resp DescribeCdDeployCountByApplicationsResp, err error) {
	err = poster.Post(c.c, "DescribeCdDeployCountByApplications", req, &resp)
	return
}

...
func (c *Cd) DescribeCdHostServerGroup(req *DescribeCdHostServerGroupReq) (resp DescribeCdHostServerGroupResp, err error) {
	err = poster.Post(c.c, "DescribeCdHostServerGroup", req, &resp)
	return
}

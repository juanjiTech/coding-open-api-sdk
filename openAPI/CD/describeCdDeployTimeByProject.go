...
func (c *Cd) DescribeCdDeployTimeByProject(req *DescribeCdDeployTimeByProjectReq) (resp DescribeCdDeployTimeByProjectResp, err error) {
	err = poster.Post(c.c, "DescribeCdDeployTimeByProject", req, &resp)
	return
}

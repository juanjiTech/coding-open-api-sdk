...
func (c *Cd) DescribeCdDeployTimeByApplications(req *DescribeCdDeployTimeByApplicationsReq) (resp DescribeCdDeployTimeByApplicationsResp, err error) {
	err = poster.Post(c.c, "DescribeCdDeployTimeByApplications", req, &resp)
	return
}

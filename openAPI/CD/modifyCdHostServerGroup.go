...
func (c *Cd) ModifyCdHostServerGroup(req *ModifyCdHostServerGroupReq) (resp ModifyCdHostServerGroupResp, err error) {
	err = poster.Post(c.c, "ModifyCdHostServerGroup", req, &resp)
	return
}

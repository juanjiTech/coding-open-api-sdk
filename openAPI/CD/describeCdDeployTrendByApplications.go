...
func (c *Cd) DescribeCdDeployTrendByApplications(req *DescribeCdDeployTrendByApplicationsReq) (resp DescribeCdDeployTrendByApplicationsResp, err error) {
	err = poster.Post(c.c, "DescribeCdDeployTrendByApplications", req, &resp)
	return
}

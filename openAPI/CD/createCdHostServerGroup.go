...
func (c *Cd) CreateCdHostServerGroup(req *CreateCdHostServerGroupReq) (resp CreateCdHostServerGroupResp, err error) {
	err = poster.Post(c.c, "CreateCdHostServerGroup", req, &resp)
	return
}

...
func (m *MergeReq) DescribeGitMergeRequestDiffs(req *DescribeGitMergeRequestDiffsReq) (resp DescribeGitMergeRequestDiffsResp, err error) {
	err = poster.Post(m.c, "DescribeGitMergeRequestDiffs", req, &resp)
	return
}

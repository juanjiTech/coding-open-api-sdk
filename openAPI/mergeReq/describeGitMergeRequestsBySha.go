...
func (m *MergeReq) DescribeGitMergeRequestsBySha(req *DescribeGitMergeRequestsByShaReq) (resp DescribeGitMergeRequestsByShaResp, err error) {
	err = poster.Post(m.c, "DescribeGitMergeRequestsBySha", req, &resp)
	return
}

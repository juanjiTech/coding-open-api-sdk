...
func (m *MergeReq) DescribeMergeRequestCommits(req *DescribeMergeRequestCommitsReq) (resp DescribeMergeRequestCommitsResp, err error) {
	err = poster.Post(m.c, "DescribeMergeRequestCommits", req, &resp)
	return
}

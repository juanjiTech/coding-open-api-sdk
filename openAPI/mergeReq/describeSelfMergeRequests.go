...
func (m *MergeReq) DescribeSelfMergeRequests(req *DescribeSelfMergeRequestsReq) (resp DescribeSelfMergeRequestsResp, err error) {
	err = poster.Post(m.c, "DescribeSelfMergeRequests", req, &resp)
	return
}

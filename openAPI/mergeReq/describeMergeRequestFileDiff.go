...
func (m *MergeReq) DescribeMergeRequestFileDiff(req *DescribeMergeRequestFileDiffReq) (resp DescribeMergeRequestFileDiffResp, err error) {
	err = poster.Post(m.c, "DescribeMergeRequestFileDiff", req, &resp)
	return
}

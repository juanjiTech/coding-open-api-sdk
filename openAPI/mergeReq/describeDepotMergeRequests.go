...
func (m *MergeReq) DescribeDepotMergeRequests(req *DescribeDepotMergeRequestsReq) (resp DescribeDepotMergeRequestsResp, err error) {
	err = poster.Post(m.c, "DescribeDepotMergeRequests", req, &resp)
	return
}

...
func (p *Project) DescribeProjectMembers(req *DescribeProjectMembersReq) (resp DescribeProjectMembersResp, err error) {
	err = poster.Post(p.c, "DescribeProjectMembers", req, &resp)
	return
}

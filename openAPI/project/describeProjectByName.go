...
func (p *Project) DescribeProjectByName(req *DescribeProjectByNameReq) (resp DescribeProjectByNameResp, err error) {
	err = poster.Post(p.c, "DescribeProjectByName", req, &resp)
	return
}

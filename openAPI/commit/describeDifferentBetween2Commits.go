...
func (c *Commit) DescribeDifferentBetween2Commits(req *DescribeDifferentBetween2CommitsReq) (resp DescribeDifferentBetween2CommitsResp, err error) {
	err = poster.Post(c.c, "DescribeDifferentBetween2Commits", req, &resp)
	return
}

...
func (c *Commit) DescribeGitFileContent(req *DescribeGitFileContentReq) (resp DescribeGitFileContentResp, err error) {
	err = poster.Post(c.c, "DescribeGitFileContent", req, &resp)
	return
}

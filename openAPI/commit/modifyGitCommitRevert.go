...
func (c *Commit) ModifyGitCommitRevert(req *ModifyGitCommitRevertReq) (resp ModifyGitCommitRevertResp, err error) {
	err = poster.Post(c.c, "ModifyGitCommitRevert", req, &resp)
	return
}

...
func (c *Commit) DescribeGitCommitStatus(req *DescribeGitCommitStatusReq) (resp DescribeGitCommitStatusResp, err error) {
	err = poster.Post(c.c, "DescribeGitCommitStatus", req, &resp)
	return
}

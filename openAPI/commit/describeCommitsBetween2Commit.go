...
func (c *Commit) DescribeCommitsBetween2Commit(req *DescribeCommitsBetween2CommitReq) (resp DescribeCommitsBetween2CommitResp, err error) {
	err = poster.Post(c.c, "DescribeCommitsBetween2Commit", req, &resp)
	return
}

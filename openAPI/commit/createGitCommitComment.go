...
func (c *Commit) CreateGitCommitComment(req *CreateGitCommitCommentReq) (resp CreateGitCommitCommentResp, err error) {
	err = poster.Post(c.c, "CreateGitCommitComment", req, &resp)
	return
}

...
func (r *Release) DescribeGitReleaseDetail(req *DescribeGitReleaseDetailReq) (resp DescribeGitReleaseDetailResp, err error) {
	err = poster.Post(r.c, "DescribeGitReleaseDetail", req, &resp)
	return
}

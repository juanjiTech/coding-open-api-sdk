...
func (g *Git) DescribeDepotByNameInfo(req *DescribeDepotByNameInfoReq) (resp DescribeDepotByNameInfoResp, err error) {
	err = poster.Post(g.c, "DescribeDepotByNameInfo", req, &resp)
	return
}

...
func (g *Git) DescribeDepotSpecDetail(req *DescribeDepotSpecDetailReq) (resp DescribeDepotSpecDetailResp, err error) {
	err = poster.Post(g.c, "DescribeDepotSpecDetail", req, &resp)
	return
}

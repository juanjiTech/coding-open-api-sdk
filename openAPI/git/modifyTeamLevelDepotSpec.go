...
func (g *Git) ModifyTeamLevelDepotSpec(req *ModifyTeamLevelDepotSpecReq) (resp ModifyTeamLevelDepotSpecResp, err error) {
	err = poster.Post(g.c, "ModifyTeamLevelDepotSpec", req, &resp)
	return
}

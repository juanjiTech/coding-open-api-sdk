...
func (g *Git) ModifyDepotFilePushRule(req *ModifyDepotFilePushRuleReq) (resp ModifyDepotFilePushRuleResp, err error) {
	err = poster.Post(g.c, "ModifyDepotFilePushRule", req, &resp)
	return
}

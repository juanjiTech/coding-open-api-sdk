...
func (g *Git) DescribeGitDepotDeployKeys(req *DescribeGitDepotDeployKeysReq) (resp DescribeGitDepotDeployKeysResp, err error) {
	err = poster.Post(g.c, "DescribeGitDepotDeployKeys", req, &resp)
	return
}

...
func (g *Git) DescribeGitProjectDeployKeys(req *DescribeGitProjectDeployKeysReq) (resp DescribeGitProjectDeployKeysResp, err error) {
	err = poster.Post(g.c, "DescribeGitProjectDeployKeys", req, &resp)
	return
}

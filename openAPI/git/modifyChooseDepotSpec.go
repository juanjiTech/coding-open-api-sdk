...
func (g *Git) ModifyChooseDepotSpec(req *ModifyChooseDepotSpecReq) (resp ModifyChooseDepotSpecResp, err error) {
	err = poster.Post(g.c, "ModifyChooseDepotSpec", req, &resp)
	return
}

...
func (g *Git) DescribeTeamDepotInfoList(req *DescribeTeamDepotInfoListReq) (resp DescribeTeamDepotInfoListResp, err error) {
	err = poster.Post(g.c, "DescribeTeamDepotInfoList", req, &resp)
	return
}

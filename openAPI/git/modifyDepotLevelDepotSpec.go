...
func (g *Git) ModifyDepotLevelDepotSpec(req *ModifyDepotLevelDepotSpecReq) (resp ModifyDepotLevelDepotSpecResp, err error) {
	err = poster.Post(g.c, "ModifyDepotLevelDepotSpec", req, &resp)
	return
}

...
func (c *Ci) DescribeCodingCIBuild(req *DescribeCodingCIBuildReq) (resp DescribeCodingCIBuildResp, err error) {
	err = poster.Post(c.c, "DescribeCodingCIBuild", req, &resp)
	return
}

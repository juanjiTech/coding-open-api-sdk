...
func (c *Ci) DescribeCodingCIBuildStep(req *DescribeCodingCIBuildStepReq) (resp DescribeCodingCIBuildStepResp, err error) {
	err = poster.Post(c.c, "DescribeCodingCIBuildStep", req, &resp)
	return
}

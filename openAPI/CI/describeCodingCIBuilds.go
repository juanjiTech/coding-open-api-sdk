...
func (c *Ci) DescribeCodingCIBuilds(req *DescribeCodingCIBuildsReq) (resp DescribeCodingCIBuildsResp, err error) {
	err = poster.Post(c.c, "DescribeCodingCIBuilds", req, &resp)
	return
}

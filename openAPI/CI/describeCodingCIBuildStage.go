...
func (c *Ci) DescribeCodingCIBuildStage(req *DescribeCodingCIBuildStageReq) (resp DescribeCodingCIBuildStageResp, err error) {
	err = poster.Post(c.c, "DescribeCodingCIBuildStage", req, &resp)
	return
}

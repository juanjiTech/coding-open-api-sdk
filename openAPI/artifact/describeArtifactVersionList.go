...
func (a *Artifact) DescribeArtifactVersionList(req *DescribeArtifactVersionListReq) (resp DescribeArtifactVersionListResp, err error) {
	err = poster.Post(a.c, "DescribeArtifactVersionList", req, &resp)
	return
}

...
func (a *Artifact) DescribeTeamArtifacts(req *DescribeTeamArtifactsReq) (resp DescribeTeamArtifactsResp, err error) {
	err = poster.Post(a.c, "DescribeTeamArtifacts", req, &resp)
	return
}

...
func (a *Artifact) DescribeArtifactProperties(req *DescribeArtifactPropertiesReq) (resp DescribeArtifactPropertiesResp, err error) {
	err = poster.Post(a.c, "DescribeArtifactProperties", req, &resp)
	return
}

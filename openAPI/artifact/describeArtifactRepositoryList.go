...
func (a *Artifact) DescribeArtifactRepositoryList(req *DescribeArtifactRepositoryListReq) (resp DescribeArtifactRepositoryListResp, err error) {
	err = poster.Post(a.c, "DescribeArtifactRepositoryList", req, &resp)
	return
}

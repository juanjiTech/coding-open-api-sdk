...
func (a *Artifact) DescribeArtifactPackageList(req *DescribeArtifactPackageListReq) (resp DescribeArtifactPackageListResp, err error) {
	err = poster.Post(a.c, "DescribeArtifactPackageList", req, &resp)
	return
}

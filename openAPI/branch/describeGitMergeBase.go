...
func (b *Branch) DescribeGitMergeBase(req *DescribeGitMergeBaseReq) (resp DescribeGitMergeBaseResp, err error) {
	err = poster.Post(b.c, "DescribeGitMergeBase", req, &resp)
	return
}
